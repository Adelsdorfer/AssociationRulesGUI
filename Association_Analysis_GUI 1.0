...
class App(tk.Tk):
    ...
    def show_top20(self):
        ...
        try:
            df = self._rules_df
            required = {'Mat_combination_id', 'cost_consequents_weighted'}
            ...
            aggregated = (
                temp.groupby('Mat_combination_id')['cost_consequents_weighted']
                .sum()
            ...
            ax.invert_yaxis()
            ax.set_xlabel('Sum of cost_consequents × combination count (EUR)')
